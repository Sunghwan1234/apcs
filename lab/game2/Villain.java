 ...
 */
public class Villain implements Character, Comparable<Character> {
  // class variable
  private static int totalVillains = 0;
   ...
   */
  public static int getTotalVillains() {
    return totalVillains;
  }
  @Override
