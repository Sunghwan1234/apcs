...
public class Feeder {
  ...
  /**
   * Instantiates current food in this feeder. (Not included in the original AP question.)
   * 
  ...
  public void simulateOneDay(int numBirds) {
    if (Math.random()<0.95) {
      currentFood -= numBirds*(int)(Math.random()*(41)+10); // bird
  ...
  public int simulateManyDays(int numBirds, int numDays) {
    System.out.println(
      "Simulate "+currentFood+" grams for "+numBirds+" birds for "+numDays+" days.");
    ...
    System.out.print(
      "Summary - Days with food: "+daysWithFood+" with "+currentFood+" remaining\n");
    return numBirds;
  }
